...
public class SimpleCLITest {
    ...
    public void givenCommandConfig_whenAdminEnableCommandExecuted_thenCorrectAvailability() {
        ...
        Assert.assertArrayEquals(new boolean[]{resultAdminDisable.isSuccess(), resultWebSaveUnavailable.isSuccess(),
                resultAdminEnable.isSuccess(), resultWebSaveAvailable.isSuccess()}, new boolean[]{true, false, true, true});
    }
